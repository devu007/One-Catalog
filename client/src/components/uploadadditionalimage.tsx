...
const UploadAdditionalImage: React.FC<UploadAdditionalImageProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row ">
      <div className="lg:w-1/3 bg-white border-[#D4D4D4]">
      ...
      <div className="lg:w-2/3 bg-white p-4">
        <div className="flex flex-row flex-wrap overflow-y-auto border p-5 rounded-md border-2 border-[#623FC4]">
          {uploadedImages.map((imageSrc, index) => (
            <div key={index} className= {`relative border-2 rounded m-2 p-2 ${selectedImage === imageSrc ? 'border-4 border-[#623FC4]' : ''}`} onClick={() => handleImageClick(imageSrc)}>
