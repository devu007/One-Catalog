const UploadButton = () => {
  ...
  return (
    <label className="mt-5 mx-5 tracking-wide font-semibold bg-[#623FC4] text-gray-100 w-80 py-2 rounded-lg transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none cursor-pointer">
      ...
      <span className="ml-3">Upload product images</span>
    </label>
  );
};
