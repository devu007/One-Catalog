    ...
    <div className="flex flex-col">
      <div className="flex-1 flex mx-5">
        <div className="w-1/3 bg-white  border-[#D4D4D4]">
          <div className="flex items-center ml-9 gap-x-16 mt-8 px-7">
            <a href="#" className="text-Black font-semibold tracking-wide ">
              Assets
            </a>
            <a
              href="#"
              className="text-Black font-semibold tracking-wide ml-7 "
            >
              Prompt
            </a>
          </div>
